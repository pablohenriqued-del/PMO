  ...
  return (
    <div data-testid="ai-copilot-container">
      <div className="dashboard-header" style={{ marginBottom: '32px', background: 'var(--sony-black)', borderBottom: '1px solid var(--sony-gray-200)' }}>
        ...
        <p className="dashboard-subtitle" style={{ color: 'var(--sony-gray-400)' }}>
          ...
          <div style={{ display: 'grid', gap: '20px' }}>
            {trends.map(trend => (
              <div key={trend.id} style={{
                ...
                <p style={{ fontSize: '13px', color: 'var(--sony-gray-400)', marginBottom: '16px' }}>
                ...
                <div style={{ background: 'rgba(0,0,0,0.5)', padding: '16px', borderRadius: '8px', marginBottom: '16px', borderLeft: '3px solid #F59E0B' }}>
                  <div style={{ fontSize: '12px', color: 'var(--sony-gray-500)', marginBottom: '4px' }}>Ação Autônoma Sugerida:</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gap: '20px' }}>
            {bottlenecks.map(bot => (
              <div key={bot.id} style={{
                ...
                <div style={{ background: 'rgba(0,0,0,0.5)', padding: '16px', borderRadius: '8px', marginBottom: '16px', borderLeft: '3px solid #3B82F6' }}>
                  <div style={{ fontSize: '12px', color: 'var(--sony-gray-500)', marginBottom: '4px' }}>Capacidade Encontrada (AD/LDAP):</div>
            ...
            {bottlenecks.length === 0 && (
              <div style={{ color: 'var(--sony-gray-500)', textAlign: 'center', padding: '32px' }}>
